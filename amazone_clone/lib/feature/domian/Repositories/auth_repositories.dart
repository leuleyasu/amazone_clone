...
try {
  final User user =User(id: "", name: name, 
...
headers:  {
   ...
   errorHandling(context: context, response: response, onSucces: () => showSnackbarCustom(context,"user with the same credential can login"),);
} catch (e) {
